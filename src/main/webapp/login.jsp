                    ...
                    <nav>
                        <ul class="nav masthead-nav">
                            ...
                            <li class="active"><a href="login.jsp"><span
                                ...
                                IN</a></li>
                            <li><a href="signup.jsp"><span class="glyphicon glyphicon-user"
                                                           aria-hidden="true"></span> SIGN UP</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="well col-xs-12 col-md-6 col-md-offset-3">
                    ...
                    <div class="row">
                        <form action="login" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2">
                                    <button type="submit" class="btn btn-primary col-xs-5 col-md-5"
                                            name="command" value="login">Log in
                                    </button>
                                    <a class="btn btn-default col-xs-5 col-xs-offset-2 col-md-5 col-md-offset-2"
                                       href="index.html" role="button">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
