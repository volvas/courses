            ...
            <div class="inner">
              ...
              <nav>
                <ul class="nav masthead-nav">
                  ...
                  <li class="active"><a href="signup.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> SIGN UP</a></li>
                </ul>
              </nav>
            </div>
          </div>
            ...
            <div class="well col-xs-12 col-md-6 col-md-offset-3">
              ...
              <div class="row">
                <form action="login" method="post">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2">
                      <button type="submit" class="btn btn-primary col-xs-5 col-md-5" name="command" value="signup">Sign up</button>
